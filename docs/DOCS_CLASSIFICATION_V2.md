...
docs/ui/PRISM_APEX_UI_DESIGN_SYSTEM.md	CANONICAL	Keep and maintain; A2 UI design system (tokens, fonts, components). Must be updated whenever V2 pages or A2 mocks change.
...
Update the relevant EPIC doc and/or UI spec under docs/specs / docs/ui/specs.
Update docs/PRISM_APEX_V2_DASHBOARD_PLAN.md if the change is user-visible.
Update docs/REPO_INDEX_V2.md if any files/routes/jobs/stores moved or were added.
Keep this classification in sync if documents are added, renamed, or archived.
