...
> Repo scan appendix removed; see README.md for up-to-date compose/profile details.
...
2. Legacy compose override artefacts (`docker-compose.override.dashboard.yml`, etc.) are intentionally retired; ensure downstream docs reference the profile-based compose stack.
