...
## Unquarantine Phase 8B — OpenAPI & SDK

- `GET /openapi.json` now serves a real OpenAPI 3.1 JSON document generated from Zod schemas.
- New package `@prism-apex-tool/sdk` adds typed fetch stubs for `/market` and `/signals`.
- No behavior changes; read-only.
